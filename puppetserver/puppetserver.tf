...
resource "vsphere_virtual_machine" "puppetserver" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "FACTER_staging_puppetserver=true /opt/puppetlabs/bin/puppet apply -e \"include profiles::puppetserver::r10k\" --hiera_config=${var.staging_code_dir}/hiera.yaml --modulepath=${var.staging_code_dir}/site:${var.staging_code_dir}/site/profiles/files/puppetserver/r10k_module_dependencies",
